...
- Navigate to the following path: /home/playtika/scenarios/17
...
- Specify the cause of the error in the project notebook for scenario 17.
...
- Solution - The solution should be mentioned in the solutions notebook.
